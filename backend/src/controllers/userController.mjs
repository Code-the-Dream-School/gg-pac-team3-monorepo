...
export const signupUser = async (req, res) => {
  ...
  try {
    ...
    const defaultprofilePictureUrl =
      "https://firebasestorage.googleapis.com/v0/b/learninghub-ggpacteam3.appspot.com/o/images%2FuserProfileImage.jpg?alt=media";
...
//fetch user profile data to display in user dashboard
