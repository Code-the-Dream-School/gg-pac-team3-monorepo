      ...
      <div>
        <div className={styling.panelContainer}>
          <div className={styling.panelText}>
            ...
            <p>
              ...
              educator looking to streamline your classroom or a learner eager
              to explore new topics, join us today to enhance your teaching
        ...
        <div className={styling.mainContainer}>
          <div className={styling.mainText}>
            ...
            <p>
              Ready to take the next step in your learning journey? Whether
              you're looking to develop new skills, advance your career, or
              explore a passion, our wide range of courses has something for
              everyone. Dive in and discover courses designed to inspire,
              challenge, and elevate you to the next level.
            </p>
